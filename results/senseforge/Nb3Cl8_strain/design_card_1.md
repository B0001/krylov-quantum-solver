...
# Design card #1: Nb3Cl8 strain sensor
...
- **Operating point:** strain = +0.0175
- **Gap at operating point:** 68.4073 meV
- **Sensitivity S = d(gap)/d(strain):** 126.7 meV/unit strain
- **Sensitivity bracket:** exact (zero-width -- see senseforge/hamiltonian.py)
- **Second derivative (plateau check):** 97.51 (curved -- a knife-edge point, see PRD sec 5)
- **Figure of merit:** 126.7
