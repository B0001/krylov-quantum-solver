...
# Design card #2: Nb3Cl8 strain sensor
...
- **Operating point:** strain = +0.015
- **Gap at operating point:** 68.0908 meV
- **Sensitivity S = d(gap)/d(strain):** 126.5 meV/unit strain
- **Sensitivity bracket:** exact (zero-width -- see senseforge/hamiltonian.py)
- **Second derivative (plateau check):** 97.67 (curved -- a knife-edge point, see PRD sec 5)
- **Figure of merit:** 126.5
